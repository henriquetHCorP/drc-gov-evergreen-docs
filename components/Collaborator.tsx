...
const Collaborator = ({ roomId, creatorId, collaborator, email, user } : CollaboratorProps) => {
  ...
  return (
    ...
    //   Collaborator 
    // </div>
    // we are inside of an unordered list(cfr shareModal where the collaborator component is inside an unordered list ) so each element should be inside a list 
